...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        tag(BlockTags.NEEDS_STONE_TOOL).add(BlockInit.COPPING_BOARD.get(), BlockInit.BURGER_MACHINE.get(), BlockInit.FRYER.get(), BlockInit.TABLE.get());
        tag(BlockTags.MINEABLE_WITH_AXE).add(BlockInit.COPPING_BOARD.get(), BlockInit.FRYER.get());
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockInit.BURGER_MACHINE.get(), BlockInit.TABLE.get());
    }
}
